...
int Disassemble8080Op(byte[] codeBuffer, int pc)
{
    ...
    switch(code)
    {
        ...
        case 0x22: Console.Write($"SHLD  ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        ...
        case 0x2A: Console.Write($"LHLD  ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        ...
        case 0x32: Console.Write($"STA   ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        ...
        case 0x3A: Console.Write($"LDA   ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        ...
        case 0xC2: Console.Write($"JNZ   ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        case 0xC3: Console.Write($"JMP   ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        case 0xC4: Console.Write($"CNZ   ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        ...
        case 0xCA: Console.Write($"JZ    ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        
        case 0xCC: Console.Write($"CZ    ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        case 0xCD: Console.Write($"CALL  ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        ...
        case 0xD2: Console.Write($"JNC   ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        case 0xD3: Console.Write($"OUT   #${AsHex(codeBuffer[pc+1])}"); opBytes = 2; break;
        case 0xD4: Console.Write($"CNC   ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        ...
        case 0xDA: Console.Write($"JC    ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        case 0xDB: Console.Write($"IN    #${AsHex(codeBuffer[pc+1])}"); opBytes = 2; break;
        case 0xDC: Console.Write($"CC    ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        ...
        case 0xE2: Console.Write($"JPO   ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        case 0xE3: Console.Write($"XTHL"); break;
        case 0xE4: Console.Write($"CPO   ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        ...
        case 0xEA: Console.Write($"JPE ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        case 0xEB: Console.Write($"XCHG"); break;
        case 0xEC: Console.Write($"CPE   ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        ...
        case 0xF2: Console.Write($"JP ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        case 0xF3: Console.Write($"DI"); break;
        case 0xF4: Console.Write($"CP ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        ...
        case 0xFA: Console.Write($"JM    ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
        case 0xFB: Console.Write($"EI"); break;
        case 0xFC: Console.Write($"CM    ${AsHex(codeBuffer[pc+2])}{AsHex(codeBuffer[pc+1])}"); opBytes = 3; break;
